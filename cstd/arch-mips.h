...
#define _NOLIBC_SYSCALL_CLOBBERLIST                                       \
    "memory", "cc", "at", "v1", "hi", "lo", "t0", "t1", "t2", "t3", "t4", \
        "t5", "t6", "t7", "t8", "t9"
 ...
 * instead. */
#define _NOLIBC_SYSCALL_CLOBBERLIST \
    "memory", "cc", "at", "v1", "10", "11", "12", "13", "14", "15", "24", "25"
...
#define my_syscall0(num)                                             \
    ({                                                               \
        ...
        register long _arg4 __asm__("a3");                           \
                                                                     \
        __asm__ volatile(_NOLIBC_SYSCALL_STACK_RESERVE               \
...
#endif                          /* _ABIO32 */
        "lui $t9, %hi(_start_c)\n" /* ABI requires current function address in
                                      $t9 */
        "ori $t9, %lo(_start_c)\n"
#if defined(_ABI64)
